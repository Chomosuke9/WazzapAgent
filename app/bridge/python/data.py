...
def chat_data(message: str, mentions: list[str] = None, sendAsReply: str = None, image: Buffer | str = None,
              video: Buffer | str = None):
  """Return a JSON string for a chat data."""
  return json.dumps({"type": "chat",
                     "content": {"message": message, "mentions": mentions, "sendAsReply": sendAsReply, "image": image,
                                 "video": video}})
