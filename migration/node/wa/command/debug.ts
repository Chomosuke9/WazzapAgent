...
async function sendDebugButtons(sock: WASocket, chatId: string): Promise<void> {
  // quick_reply × 3
...
async function sendDebugMenu(sock: WASocket, chatId: string): Promise<void> {
...
async function sendDebugList(sock: WASocket, chatId: string): Promise<void> {
...
async function sendDebugRichMessage(sock: WASocket, chatId: string): Promise<void> {
...
async function sendDebugCombined(sock: WASocket, chatId: string): Promise<void> {
...
async function sendDebugBroadcast(sock: WASocket, chatId: string): Promise<void> {
  await sendRichMessage(sock, chatId, {
...
async function sendDebugCarousel(sock: WASocket, chatId: string): Promise<void> {
...
async function sendDebugCarouselImg(sock: WASocket, chatId: string, imageUrl: string | null): Promise<void> {
...
async function handleDebugCommand({ chatId, senderId, args, sock }: CommandContext): Promise<void> {
  ...
  const send = async (
    fn: (sock: WASocket, chatId: string, ...fnArgs: any[]) => Promise<unknown>,
    label: string,
    ...fnArgs: any[]
  ): Promise<void> => {
    try {
