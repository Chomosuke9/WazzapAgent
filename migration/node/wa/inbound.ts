...
import { forwardIncoming } from '../account/eventForwarder.js';
import {
  normalizeJid,
...
import type { Attachment, WhatsAppMessagePayload, AccountEntry } from '../protocol/types.js';
...
async function handleIncomingMessage(
  ...
  const payload: WhatsAppMessagePayload = {
    ...
    // attachments are SavedAttachment). Reconciled in a later step.
    quoted,
