...
async function handleModel({
  ...
  if (modelIdArg && modelIdArg !== "global") {
    ...
    if (targetModel) {
      if (isGlobal) {
        repos!.model.setGlobalLlm2Model(targetModel.modelId);
        ...
        repos!.model.setLlm2Model(chatId, targetModel.modelId);
        registry.sendReliableToClient(folderPath, {
          type: "set_llm2_model",
          folderPath,
          chatId,
...
export const modelCommand: CommandHandler = { name: "model", aliases: ["models"], run: handleModel };