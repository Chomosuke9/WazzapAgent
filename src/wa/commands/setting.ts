            ...
            rows: [
              {
                id: "mode_select:auto",
                title: "Auto",
                description: "LLM decides when to respond",
              },
              {
                id: "mode_select:prefix",
                title: "Prefix",
                description: "Only responds when triggered",
              },
              {
                id: "mode_select:hybrid",
                title: "Hybrid",
                description: "Prefix first, fallback to auto",
              },
            ],
          },
        ],
          ...
          rows: [
            {
              ...
              title: "Auto",
              description: "Match the chat device automatically",
            },
            {
              id: "compat_select:full",
              title: "Full",
              description: "All interactive (Android)",
            },
            {
              id: "compat_select:semi",
              title: "Semi",
              description: "No list menus (iOS)",
            },
            {
              id: "compat_select:safe",
              title: "Safe",
              description: "Plain text only (web/desktop)",
            },
          ],
        },
      ],
      ...
      sections: [
        {
          ...
          rows: [
            ...
            },
            {
              id: "/reset",
              title: "Reset Chat",
              description: "Clear bot memory for this chat",
            },
          ],
        },
      ],
...
export const settingCommand: CommandHandler = {
  ...
  description:
    "Open the interactive settings menu for this chat. From here you can change the response mode, LLM model, system prompt, moderation permission, and other settings without memorizing commands.",
